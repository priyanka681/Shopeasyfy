...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   public UserDetailsService userDetailsService() {
	   return new ShopeasyfyUserDetailsService();
   }
...
//		http
//		.authorizeRequests()
//            .antMatchers("/home","/ShopeasyfyAdmin/login","/categories/new","/category_form").permitAll()
//		.antMatchers("/users/**").hasAuthority("Admin")
//		//.antMatchers("/ShopeasyfyAdmin").permitAllutho()
...
//		   //.defaultSuccessUrl("/ShopeasyfyAdmin")
