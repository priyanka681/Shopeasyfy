...
public class SettingRepositoryTests {
	...
	//	 Setting siteName = new Setting("SITE_NAME", "Shopeasyfy", SettingCategory.GENERAL); 
		 ...
		 Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2023 Shopeasyfy Ltd.", SettingCategory.GENERAL);
    ...
    public void testCreateCurrencySettings(){
	   ...
	   Setting symbol = new Setting("CURRENCY_SYMBOL", "NPR", SettingCategory.CURRENCY);
